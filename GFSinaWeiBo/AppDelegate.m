...
- (void)applicationWillResignActive:(UIApplication *)application {
    ...
    NSURL *songUrl = [[NSBundle mainBundle] URLForResource:@"smile.mp3" withExtension:nil];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "goofyy.com.GFSinaWeiBo" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"GFSinaWeiBo" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"GFSinaWeiBo.sqlite"];
    NSError *error = nil;
